...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'xinnyeinoo93@gmail.com',
  ...
  protectedRoutes: ['/🌞 Private folder/u-need-a-password', '/🥟 Some test files/root'],
